...
class ProfileCog (commands .Cog ):
    ...
    @app_commands .command (name ="profile",description ="Displays a user's profile. Defaults to your profile if no user is provided.")
    ...
    async def profile (self ,interaction :discord .Interaction ,user :discord .User =None ):
        ...
        view =ProfileNavigationView (pages ,store_button =store_button ,custom_button =custom_ui_button ,authorized_user =interaction .user ,timeout =60 )


        if (user .id ==interaction .user .id )and (not is_registered ):
