...
import discord 
from functions .dashboard_functions .profilesettings .store import update_dashboard_store ,fetch_dashboard_store 
...
class StoreModal (discord .ui .Modal ,title ="Update Store"):
    store_input =discord .ui .TextInput (
    label ="Enter Store Name:",
    style =discord .TextStyle .short ,
    required =False ,
    max_length =150 ,
    placeholder ="Type your store name here (max 150 characters)..."
    )
    ...
    async def on_submit (self ,interaction :discord .Interaction ):
        new_store =self .store_input .value 
        update_dashboard_store (self .user_id ,new_store )
